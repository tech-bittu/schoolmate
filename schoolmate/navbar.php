  ...
  <div class="container-lg">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="./forfun.php">RandomSelector</a>
            </li>
          </ul>

          <form class="d-flex changeafter">
            <input class="form-control me-2" type="search" placeholder="Welcome :" readonly aria-label="Search">
    ...
    <script type="text/javascript" defer>
      ...
      ?>
        ...
        loginSpan.innerHTML = ' <input class="form-control me-2" type="search" placeholder="Welcome : <?= $_SESSION['sname'] ?><?= $_SESSION['sAdminName'] ?>" readonly aria-label="Search"><a href="./logout.php"><button class="btn btn-outline-success" type="button">Logout</button></a>';
        ...
        ?>
          ...
          spanli.innerHTML = '<a class="nav-link "  href="./admin/message.php">Message</a>';
          navCon.append(spanli);
          const secli = document.createElement('li');
          secli.classList.add('nav-item');
          secli.innerHTML = '<a class="nav-link "  href="./admin/registerData.php">RegisterData</a>';
          navCon.append(secli);
